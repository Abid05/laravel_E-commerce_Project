                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="form-group col-lg-6">
                      ...
                      <input type="text" class=form-control name="unit" value="{{ $product->code }}" required="">
                    </div>
                    <div class="form-group col-lg-6">
      ...
      //  var postURL = "<?php echo url('addmore'); ?>";
       ...
       $('#add').click(function(){  
            ...
            $('#dynamic_field').append(
              '<tr id="row'+i+'" class="dynamic-added"><td><input type="file" accept="image/*" name="images[]" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
       });  
